...
let textPieces = [];
let textPiecesSize = 100; // dynamisch die größe der ausschnitte anpassen

const divider = (input) => {
  for (let i = 0; i < input.length; i += textPiecesSize) {
    textPieces.push(input.substring(i, i + textPiecesSize));
  }
